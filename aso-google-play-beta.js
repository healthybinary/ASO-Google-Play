...
// @downloadURL  https://raw.githubusercontent.com/ayoubfletcher/ASO-Google-Play/master/aso-google-play-beta.js
// ==/UserScript==
...
function injectData(app, developer) {
    ...
    // Inject result
    let elemTarget = $('.info-box-top .document-subtitles')[1];
    if(elemTarget == null) {
